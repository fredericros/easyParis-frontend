...
<View style={{position: "absolute", left: 290, bottom: 480, backgroundColor: 'black', backgroundColor: 'white',width: 60, height: 60, borderRadius: 50, shadowColor: "#000",
shadowOffset: {
	width: 0,
	height: 5,
},
...
<FontAwesome  name="heart" size={30} color='black' style={{position: 'absolute', left: 15, top: 15,   }}/>


    </View>

    <View style={{position: "absolute", left: 220, bottom: 480, backgroundColor: 'black', backgroundColor: 'white', width: 60, height: 60, borderRadius: 50, shadowColor: "#000",
shadowOffset: {
	width: 0,
	height: 5,
},
...
<FontAwesome  name="location-arrow" size={32} color='blue' style={{position: 'absolute', left: 15, top: 15,   }}/>
